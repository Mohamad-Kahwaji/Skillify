...
<head>
  ...
  <style>
    ...
    *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    .input-wrap select option { background: var(--bg-surface); }
    .select-wrap { position: relative; }
    .select-wrap::after {
      content: '\ea77'; font-family: 'tabler-icons';
...
<div class="wrap">
  <div class="brand">
    ...
    <div class="brand-sub">انضم إلى منصة المهن والحرف</div>
  </div>

  <div class="card">
    <div class="card-title">إنشاء حساب جديد</div>
    <div class="card-sub">أدخل بياناتك لإنشاء حسابك</div>
    ...
    <form method="POST" action="{{ route('user.register.post') }}">
      ...
      <div class="section-sep">المعلومات الشخصية</div>
      ...
      <div class="form-row">
        <div class="form-group">
          ...
          <div class="input-wrap">
            ...
            <input type="text" name="first_name" placeholder="محمد"
        ...
        <div class="form-group">
          ...
          <div class="input-wrap">
            <i class="ti ti-user"></i>
            <input type="text" name="last_name" placeholder="أحمد"
        ...
        <div class="form-group">
          ...
          <div class="input-wrap select-wrap">
            ...
            <select name="gender" required>
              <option value="" disabled {{ old('gender') ? '' : 'selected' }}>اختر</option>
      ...
      <div class="form-group">
        ...
        <div class="input-wrap">
          ...
          <input type="text" name="city" placeholder="دمشق"
                 value="{{ old('city') }}" required>
        </div>
        @error('city')<div class="field-error">{{ $message }}</div>@enderror
      </div>

      <div class="section-sep">بيانات الحساب</div>
    ...
    <div class="footer-link">
      لديك حساب بالفعل؟ <a href="{{ route('user.login') }}">تسجيل الدخول</a>
    </div>
  </div>
</div>
