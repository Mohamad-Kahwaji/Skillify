  ...
  <div class="auth-panel">
    <div class="panel-top">
      ...
      <div class="panel-desc">
        أدخل بريدك الإلكتروني المسجّل، وسنرسل لك رمز تحقق لإعادة تعيين كلمة مرور حساب الإدارة.
      </div>

      <div class="panel-note">
        <i class="ti ti-shield-lock"></i>
        <span>لأسباب أمنية، ينتهي صلاحية رمز التحقق بعد وقت قصير من إرساله.</span>
      </div>
        ...
        <div class="form-group">
          ...
          <div class="input-wrap">
            ...
            <input type="email" name="email" value="{{ old('email') }}"
                   placeholder="admin@skillify.com" autofocus autocomplete="email" required dir="ltr">
          </div>
          @error('email')
