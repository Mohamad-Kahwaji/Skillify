  ...
  <style>
    ...
    *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    .brand-icon {
      ...
      box-shadow: 0 0 28px rgba(29,158,117,.35);
    }
    .brand-name { font-size: 22px; font-weight: 600; letter-spacing: -0.4px; }
    .brand-badge {
      display: inline-flex; align-items: center; gap: 5px;
      background: rgba(29,158,117,.15); border: 0.5px solid rgba(29,158,117,.3);
...
<div class="wrap">
  ...
  <div class="card">
    ...
    <div class="card-sub">لوحة تحكم المدير الأعلى</div>
    ...
    <div class="divider">
      لوحة الأدمن العادية؟ <a href="{{ route('admin.login') }}">اضغط هنا</a>
    </div>
  </div>
</div>
