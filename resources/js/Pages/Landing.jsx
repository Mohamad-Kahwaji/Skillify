...
const CATEGORY_ICON_PATHS = {
    ...
    currencyDollar:  ['M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-9c-1.11 0-2.08.402-2.599 1M21 12a9 9 0 11-18 0 9 9 0 0118 0z'],
    desktopComputer: ['M9.75 17L9 20l-1 1h8l-1-1-.75-3M3 13h18M5 17h14a2 2 0 002-2V5a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z'],
    colorSwatch:     ['M7 21a4 4 0 01-4-4V5a2 2 0 012-2h4a2 2 0 012 2v12a4 4 0 01-4 4zm0 0h12a2 2 0 002-2v-4a2 2 0 00-2-2h-2.343M11 7.343l1.657-1.657a2 2 0 012.828 0l2.829 2.829a2 2 0 010 2.828l-8.486 8.485M7 17h.01'],
    ...
    fire:            ['M17.657 18.657A8 8 0 016.343 7.343S7 9 9 10c0-2 .5-5 2.986-7C14 5 16.09 5.777 17.657 7.343A7.975 7.975 0 0120 13a7.975 7.975 0 01-2.343 5.657z', 'M9.879 16.121A3 3 0 1012.015 11L11 14H9c0 .768.293 1.536.879 2.121z'],
    cube:            ['M20 7l-8-4-8 4m16 0l-8 4m8-4v10l-8 4m0-10L4 7m8 4v10M4 7v10l8 4'],
    sparkles:        ['M5 3v4M3 5h4M6 17v4m-2-2h4m5-16l2.286 6.857L21 12l-5.714 2.143L13 21l-2.286-6.857L5 12l5.714-2.143L13 3z'],
    beaker:          ['M9 3h6m-6 0v5.379a2 2 0 01-.586 1.415L4.828 18.38A2 2 0 006.243 21.8h11.514a2 2 0 001.415-3.414l-7.586-8.593A2 2 0 0111 8.379V3'],
...
const CATEGORY_ICON_RULES = [
    ...
    [/قانون|محام/,        'scale'],
    [/هندس/,             'cog'],
    [/تعليم|تدريس/,       'academicCap'],
    [/محاسب|مال/,         'currencyDollar'],
    [/تقنية|حاسوب|معلومات/, 'desktopComputer'],
    [/فن|تصميم/,          'colorSwatch'],
    [/إعلام|صحاف/,        'speakerphone'],
    [/كهرباء|سباكة/,      'bolt'],
    [/حداد|معادن/,        'fire'],
    [/نجارة|أثاث/,        'cube'],
    [/تجميل|عناية/,       'sparkles'],
    [/معمل|مختبر|استوديو/, 'beaker'],
    [/شركة|بناء|تشييد/,    'officeBuilding'],
];

function getCategoryIconPaths(name = '') {
            ...
            <nav className="fixed inset-x-0 top-0 z-50 bg-white/95 backdrop-blur-sm border-b border-gray-100 shadow-sm">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
                    ...
                    <div className="flex items-center">
                        <img src="/images/logo-dark-text.jpg" alt="Skillify" className="h-12 w-auto" />
                    </div>
                                ...
                                <Link key={cat.id} href="/register"
                                    ...
                                    <div className="w-12 h-12 rounded-xl bg-[#F0FDFA] group-hover:bg-white/20 mx-auto mb-3 flex items-center justify-center">
                                        <svg className="w-6 h-6 text-[#0D9488] group-hover:text-white transition-colors" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                            {getCategoryIconPaths(cat.name).map((d, i) => (
